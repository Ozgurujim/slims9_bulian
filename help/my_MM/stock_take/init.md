...
After the **Initialisation** is done, the **Current Stocktake** menu and **Stocktake Report** will serve as menus for stock-take activities, coupled with the navigation menu to be used to conduct a stock-take along with the **Stocktake Finish** menu, **Current Lost Items**, **Stocktake Log**, and **Resynchronise**.



<a href="https://slims.web.id/docs/user-guide/Modules/Stocktake/stocktakehistory" 
