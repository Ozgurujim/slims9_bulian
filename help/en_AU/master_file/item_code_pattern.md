...
Complete each field then click the SAVE button. 

The Prefix and Suffix fields are constants that will appear in each code generated. The Serial Number length default is 5. This would be sufficient to service a collection of 1 million items.  A preview shows the first composite code.
